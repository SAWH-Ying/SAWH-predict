...
TG_ADin = 25;RHG_ADin = 60;Patm = 101325;
...
figure
box on
set(gca,'LooseInset',[0 0 0 0],'xLim',[2500 3000])
hold on
plot(2500:10:3000,OP(:,1),'Linewidth',2,'Color',[230,111,81]/255);
plot(2500:10:3000,OP(:,2),'Linewidth',2,'Color',[243,162,97]/255);
plot(2500:10:3000,OP(:,3),'Linewidth',2,'Color',[232,197,107]/255);
plot(2500:10:3000,OP(:,4),'Linewidth',2,'Color',[138,176,125]/255);
plot(2500:10:3000,OP(:,5),'Linewidth',2,'Color',[41,157,143]/255);
plot(2500:10:3000,OP(:,6),'Linewidth',2,'Color',[40,114,113]/255);
xlabel('Qst(kJ/kg)')
