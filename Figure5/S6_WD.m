...
TG_ADin = 50;RHG_ADin = 7.5;Patm = 101325;

WDcycle = 0.2;OP = zeros(60,6);
for m = 1:60
    WDcycle = m/100;
    for n = 1:6
...
figure
hold on
plot(0.01:0.01:0.6,OP(:,1),'Linewidth',2,'Color',[230,111,81]/255);
plot(0.01:0.01:0.6,OP(:,2),'Linewidth',2,'Color',[243,162,97]/255);
plot(0.01:0.01:0.6,OP(:,3),'Linewidth',2,'Color',[232,197,107]/255);
plot(0.01:0.01:0.6,OP(:,4),'Linewidth',2,'Color',[138,176,125]/255);
plot(0.01:0.01:0.6,OP(:,5),'Linewidth',2,'Color',[41,157,143]/255);
plot(0.01:0.01:0.6,OP(:,6),'Linewidth',2,'Color',[40,114,113]/255);
xlabel('P(pa)')
ylabel('energy requirement(MJ/kg)')
